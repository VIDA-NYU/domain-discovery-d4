 ...
 */
public class JISimilarityHashLargeOuter implements EQSimilarity {

    private final JaccardIndex _ji;
    private final HashMap<Integer, HashSet<Integer>> _nodes;
    
    public JISimilarityHashLargeOuter(HashMap<Integer, HashSet<Integer>> nodes) {
    ...
    public static JISimilarityHashLargeOuter load(File eqFile) throws java.io.IOException {
        ...
        return new JISimilarityHashLargeOuter(nodes);
    }
