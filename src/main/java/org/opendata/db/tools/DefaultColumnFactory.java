...
/**
 *Default implementation for the column file factory interface. This implementation
 * is intended for use when converting the fill dataset into column files.
 * 
